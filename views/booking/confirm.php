            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="booking-summary mb-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <p><i class="bi bi-geo-alt me-2"></i> <strong>Nhà hát:</strong> <?= htmlspecialchars($theater['name']) ?></p>
                                <p><i class="bi bi-calendar-event me-2"></i> <strong>Ngày:</strong> <?= date('l, d/m/Y', strtotime($booking_details['schedule_date'])) ?></p>
                                <p><i class="bi bi-clock me-2"></i> <strong>Giờ:</strong> <?= date('H:i', strtotime($booking_details['schedule_time'])) ?> - <?= date('H:i', strtotime($booking_details['schedule_end_time'])) ?></p>
                            </div>
                            <div class="col-md-6">
                                <p><i class="bi bi-person me-2"></i> <strong>Đặt bởi:</strong> <?= htmlspecialchars($_SESSION['user']['username']) ?></p>
                                <p><i class="bi bi-envelope me-2"></i> <strong>Email:</strong> <?= htmlspecialchars($_SESSION['user']['email']) ?></p>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($selectedSeatsInfo as $seat): ?>
                                        <tr>
                                            ...
                                            <td class="text-end"><?= number_format($seat['price']) ?> đ</td>
                                        </tr>
                                    <?php endforeach; ?>
                                    <tr class="table-light">
                                        <td colspan="2"><strong>Tổng cộng</strong></td>
                                        <td class="text-end"><strong><?= number_format($totalPrice) ?> đ</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
